    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (string file in fileArray)
                    {
                        ...
                        string output = Path.Combine(sourceDir, Path.GetFileNameWithoutExtension(file) + "_已盖章.pdf");
                        string source = file;
                        string input = source;
                        if (checkMultiple.Checked == true && File.Exists(output))
                        {
                        ...
                        if (isSurrcess)
                        {
                            ...
                            if (pdfpassword != "")
                            {
                                string jmoutput = Path.Combine(sourceDir, Path.GetFileNameWithoutExtension(file) + "_已盖章_加密.pdf");
        ...
        public void viewPDFPage()
        {
            ...
            if (arrRow == null || arrRow.Length == 0)
            {
                ...
                else if (comboYz.SelectedIndex == 5 && imgStartPage != 1)
                {
                    pictureBox2.Visible = false;
                }
